                                        ...
                                        @foreach ($data as $index => $value)
                                            <tr>
                                                ...
                                                <td> <img class="img-fluid" width="100" src="{{ $value->image }}"
                                                        alt="{{ $value->title }}"> </td>
                                                <td> <a target="_blank" href="{{ $value->link }}">
                                                        {{ $value->link }}</a> </td>
                                                <td>
                                                    {{ $value->description }}
                                                </td>
                                                ...
                                                <td class="text-right">
                                                    ...
                                                    @component('cms::components.modals.update')
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <span class="input-group-btn">
                                                                    <a data-input="image-e-{{ $value->id }}"
                                                                        data-preview="image-edit-{{ $value->id }}"
                                                                        class="lfm btn btn-primary text-white">
                                                                        <i class="fa fa-picture-o"></i> Choose
                                                                    </a>
                                                                </span>
                                                                <input id="image-e-{{ $value->id }}" class="form-control"
                                                                    name="image">
                                                            </div>
                                                            <img id="image-edit-{{ $value->id }}"
