                        ...
                        <ul class="cmt-recent-post-list">
                            <li>
                                <a href="/themes/{{ $theme }}/#"><img
                                        src="https://via.placeholder.com/69x65/848484/FFFFFF.jpg"
                                        alt="post-01"></a>
                                <a href="/themes/{{ $theme }}/single-blog.html">Our Biggest Summer
                                    Meetup</a>
                ...
                <div class="col-md-4 cmt-footer2-right">
                    <div class="social-icons">
                        <ul class="list-inline">
                            <li><a href="/themes/{{ $theme }}/#"><i class="ti ti-facebook"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="/themes/{{ $theme }}/#"><i class="ti ti-linkedin"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="/themes/{{ $theme }}/#"><i class="ti ti-twitter"
                                        aria-hidden="true"></i></a></li>
                            <li><a href="/themes/{{ $theme }}/#"><i class="ti ti-google"
                                        aria-hidden="true"></i></a></li>
                        </ul>
                    </div>
                </div>
